...
<body class="min-h-screen flex">
    ...
    <aside class="w-60 flex flex-col min-h-screen fixed shadow-lg" style="background-color: #1B3A6B;">
        <div class="px-5 py-5 border-b border-blue-900">
            <p class="text-xs font-mono" style="color: #2B8AC6;">OPMAS-001</p>
            <p class="text-base font-bold text-white mt-1">AIC Kijabe Hospital</p>
            <p class="text-xs mt-0.5" style="color: #93B8D8;">OX-PLANT-01</p>
        </div>
