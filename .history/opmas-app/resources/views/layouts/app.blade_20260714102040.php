    ...
    <aside class="w-72 flex flex-col min-h-screen fixed shadow-lg bg-[#102A5F] text-white">
        <div class="px-5 py-5 border-b border-blue-900">
            <div class="flex items-center gap-3">
                <div class="h-16 w-16 rounded-3xl bg-white/10 p-2 flex items-center justify-center">
                    <img src="{{ asset('images/kijabe-logo.svg') }}" alt="Kijabe Hospital" class="h-full w-full object-contain" />
                </div>
                <div>
                    <p class="text-xs font-mono text-[#8DBBE5]">OPMAS-001</p>
                    <p class="text-lg font-bold text-white leading-tight">Kijabe Hospital</p>
                    <p class="text-xs text-[#B8CDE6] mt-0.5">OX-PLANT-01</p>
                </div>
            </div>
        </div>
