...
<div class="grid grid-cols-1 md:grid-cols-4 gap-4 mb-8">
    <div class="rounded-xl p-5 shadow-sm border" style="background:#FFFFFF; border-color:#DDE3EE;">
        <p class="text-xs uppercase tracking-widest mb-2" style="color:#6B7A90;">Total equipment</p>
        <p class="text-3xl font-bold" style="color:#1B3A6B;">{{ $equipment->count() }}</p>
    </div>
    <div class="rounded-xl p-5 shadow-sm border" style="background:#FFFFFF; border-color:#DDE3EE;">
        <p class="text-xs uppercase tracking-widest mb-2" style="color:#6B7A90;">Online</p>
        <p class="text-3xl font-bold" style="color:#15803D;">{{ $statusCounts['ONLINE'] ?? 0 }}</p>
    </div>
    <div class="rounded-xl p-5 shadow-sm border" style="background:#FFFFFF; border-color:#DDE3EE;">
        <p class="text-xs uppercase tracking-widest mb-2" style="color:#6B7A90;">Fault</p>
        <p class="text-3xl font-bold" style="color:#B91C1C;">{{ $statusCounts['FAULT'] ?? 0 }}</p>
    </div>
    <div class="rounded-xl p-5 shadow-sm border" style="background:#FFFFFF; border-color:#DDE3EE;">
        <p class="text-xs uppercase tracking-widest mb-2" style="color:#6B7A90;">Maintenance due</p>
        <p class="text-3xl font-bold" style="color:#1B3A6B;">{{ $upcomingService->count() }}</p>
    </div>
</div>
